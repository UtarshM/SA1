  ...
  const workshops = [
    {
      ...
      rating: 4.8,
      level: 'Beginner',
      description: 'Discover machine learning fundamentals and understand if our ML Mastery program is right for you.',
      highlights: ['Hands-on coding intro', 'Program structure overview', 'Learning path guidance', 'Q&A with instructors'],
      image: 'https://images.pexels.com/photos/8386440/pexels-photo-8386440.jpeg?auto=compress&cs=tinysrgb&w=400',
      topics: ['What is ML?', 'Basic Algorithms', 'Real Dataset Exploration', 'Program Roadmap'],
    ...
    },
    {
      ...
      rating: 4.9,
      level: 'Intermediate',
      description: 'Experience deep learning concepts and see if our advanced Deep Learning program matches your goals.',
      highlights: ['Neural network basics', 'Program curriculum preview', 'Career pathway discussion', 'Enrollment guidance'],
  ...
  const features = [
    {
      ...
      description: "Explore different AI domains and identify your interests"
    },
    {
      icon: <Users className="h-8 w-8 text-green-600" />,
      title: "Live Learning Experience",
      description: "Experience our teaching methodology and instructor interaction"
    },
    {
      icon: <CheckCircle className="h-8 w-8 text-purple-600" />,
      title: "Hands-on Practice",
      description: "Work on practical exercises and understand program structure"
    },
    {
      icon: <Play className="h-8 w-8 text-orange-600" />,
      title: "Program Guidance",
      description: "Get recommendations on which full program suits your goals"
    }
  ];
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Discover your learning path through hands-on workshops. Experience our teaching approach and find the right program for you.
            </p>
          </div>
        </div>
      </section>
      ...
      <section className="py-20 bg-white">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-600 max-w-3xl mx-auto">
              Workshops help you discover the right learning path before committing to a full program
            </p>
          </div>
