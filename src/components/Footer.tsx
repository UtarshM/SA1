          ...
          <div className="lg:col-span-2 md:col-span-2">
            ...
            <div className="space-y-3">
              <div className="flex items-start space-x-3">
                ...
                <span className="text-gray-300">iHub (IIT Gandhinagar Innovation & Incubation Centre), PDPU Innovation & Incubation Centre, Raisan, Gandhinagar, Gujarat 382007</span>
              </div>
